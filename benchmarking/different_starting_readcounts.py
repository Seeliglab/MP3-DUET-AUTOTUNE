...
deseq_homo_af_batch_f_1 = pd.read_csv('../processing_pipeline/merged_replicates/deseq_l68_psuedoreplicate_autotune_f_10.csv')
deseq_homo_af_batch_f_1 = deseq_homo_af_batch_f_1.rename(columns = {'Unnamed: 0': 'PPI'})
deseq_homo_af_batch_f_3 = pd.read_csv('../processing_pipeline/merged_replicates/deseq_l68_psuedoreplicate_autotune_f_20.csv')
deseq_homo_af_batch_f_3 = deseq_homo_af_batch_f_3.rename(columns = {'Unnamed: 0': 'PPI'})
deseq_homo_af_batch_f_5 = pd.read_csv('../processing_pipeline/merged_replicates/deseq_l68_psuedoreplicate_autotune_f_30.csv')
deseq_homo_af_batch_f_5 = deseq_homo_af_batch_f_5.rename(columns = {'Unnamed: 0': 'PPI'})
deseq_homo_af_batch_f_10 = pd.read_csv('../processing_pipeline/merged_replicates/deseq_l68_psuedoreplicate_autotune_f_40.csv')
...
deseq_homo_af_batch = pd.read_csv('../processing_pipeline/merged_replicates/deseq_jerala_flat_autotune_5_small.csv')
deseq_homo_af_batch = deseq_homo_af_batch.rename(columns = {'Unnamed: 0': 'PPI'})
deseq_homo_af_batch_f_1 = pd.read_csv('../processing_pipeline/merged_replicates/deseq_jerala_flat_f_10.csv')
deseq_homo_af_batch_f_1 = deseq_homo_af_batch_f_1.rename(columns = {'Unnamed: 0': 'PPI'})
deseq_homo_af_batch_f_3 = pd.read_csv('../processing_pipeline/merged_replicates/deseq_jerala_flat_f_20.csv')
deseq_homo_af_batch_f_3 = deseq_homo_af_batch_f_3.rename(columns = {'Unnamed: 0': 'PPI'})
deseq_homo_af_batch_f_5 = pd.read_csv('../processing_pipeline/merged_replicates/deseq_jerala_flat_f_30.csv')
deseq_homo_af_batch_f_5 = deseq_homo_af_batch_f_5.rename(columns = {'Unnamed: 0': 'PPI'})
deseq_homo_af_batch_f_10 = pd.read_csv('../processing_pipeline/merged_replicates/deseq_jerala_flat_f_40.csv')
deseq_homo_af_batch_f_10 = deseq_homo_af_batch_f_10.rename(columns = {'Unnamed: 0': 'PPI'})
